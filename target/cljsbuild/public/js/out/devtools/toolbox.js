...
var args64855 = [];
var len__49232__auto___64861 = arguments.length;
var i__49233__auto___64862 = (0);
while(true){
if((i__49233__auto___64862 < len__49232__auto___64861)){
args64855.push((arguments[i__49233__auto___64862]));

var G__64863 = (i__49233__auto___64862 + (1));
i__49233__auto___64862 = G__64863;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args64855.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox64858 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox64858 = (function (obj,header,style,tag,meta64859){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
this.meta64859 = meta64859;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
})
devtools.toolbox.t_devtools$toolbox64858.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_64860,meta64859__$1){
var self__ = this;
var _64860__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox64858(self__.obj,self__.header,self__.style,self__.tag,meta64859__$1));
});

devtools.toolbox.t_devtools$toolbox64858.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_64860){
var self__ = this;
var _64860__$1 = this;
return self__.meta64859;
});

devtools.toolbox.t_devtools$toolbox64858.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox64858.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox64858.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox64858.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox64858.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta64859","meta64859",-490847833,null)], null);
});

devtools.toolbox.t_devtools$toolbox64858.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox64858.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox64858";

devtools.toolbox.t_devtools$toolbox64858.cljs$lang$ctorPrWriter = (function (this__48730__auto__,writer__48731__auto__,opt__48732__auto__){
return cljs.core._write.call(null,writer__48731__auto__,"devtools.toolbox/t_devtools$toolbox64858");
});

devtools.toolbox.__GT_t_devtools$toolbox64858 = (function devtools$toolbox$__GT_t_devtools$toolbox64858(obj__$1,header__$1,style__$1,tag__$1,meta64859){
return (new devtools.toolbox.t_devtools$toolbox64858(obj__$1,header__$1,style__$1,tag__$1,meta64859));
});

}

return (new devtools.toolbox.t_devtools$toolbox64858(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
