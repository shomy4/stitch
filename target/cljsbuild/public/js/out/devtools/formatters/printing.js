...
var len__49232__auto___53563 = arguments.length;
var i__49233__auto___53564 = (0);
while(true){
if((i__49233__auto___53564 < len__49232__auto___53563)){
args__49239__auto__.push((arguments[i__49233__auto___53564]));

var G__53565 = (i__49233__auto___53564 + (1));
i__49233__auto___53564 = G__53565;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__49240__auto__);
});
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53561,G__53562,seq53560__$2);
});
...
if(cljs.core.truth_((function (){var or__48119__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__48730__auto__,writer__48731__auto__,opt__48732__auto__){
return cljs.core._write.call(null,writer__48731__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__48107__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__48107__auto__){
var or__48119__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53566_SHARP_){
return !((cljs.core.meta.call(null,p1__53566_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__53575__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__48119__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53579){var e__50876__auto__ = e53579;
return false;
}})();
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
...
}catch (e53581){var e__50876__auto__ = e53581;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53586 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53587 = opts;
...
var markup_db = cljs.core.get.call(null,map__53587__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53586;
}});
...
;
var temp__4655__auto___53592 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___53592)){
var managed_print_level_53593 = temp__4655__auto___53592;
var _STAR_print_level_STAR_53591_53594 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53593;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53591_53594,managed_print_level_53593,temp__4655__auto___53592,writer,opts,job_fn){
return (function (p1__53589_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53589_SHARP_,null);
});})(_STAR_print_level_STAR_53591_53594,managed_print_level_53593,temp__4655__auto___53592,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53591_53594;
}} else {
job_fn.call(null);
}
