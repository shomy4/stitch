...
var G__53520 = devtools.prefs.pref.call(null,v);
v = G__53520;
continue;
} else {
return v;
...
var and__48107__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__48107__auto__){
var and__48107__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__48119__auto__ = (function (){try{if(!((value == null))){
...
}catch (e53533){var e__50876__auto__ = e53533;
return false;
}})();
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
var or__48119__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e53537){var e__50876__auto__ = e53537;
return false;
}})();
...
}catch (e53539){var e__50876__auto__ = e53539;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__48107__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__48107__auto__)){
var and__48107__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__48107__auto____$1){
...
var and__48107__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__48107__auto__)){
...
var or__48119__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
...
var and__48107__auto__ = (function (){var or__48119__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
...
var vec__53544 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__53544,(0),null);
var name = cljs.core.nth.call(null,vec__53544,(1),null);
...
var and__48107__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__48107__auto__)){
...
var or__48119__auto__ = typeof value === 'string';
if(or__48119__auto__){
return or__48119__auto__;
} else {
var or__48119__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__53547_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__53547_SHARP_);
}),template);
});
