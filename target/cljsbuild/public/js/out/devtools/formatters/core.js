...
var and__48107__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__48107__auto__){
var or__48119__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e54016){var e__50876__auto__ = e54016;
return false;
...
}catch (e54018){var e__50876__auto__ = e54018;
return false;
...
}catch (e54024){var e__50876__auto__ = e54024;
return false;
...
}catch (e54026){var e__50876__auto__ = e54026;
return false;
...
}catch (e54032){var e__50876__auto__ = e54032;
return false;
}})())){
...
}catch (e54034){var e__50876__auto__ = e54034;
return false;
}})())){
...
var _STAR_current_state_STAR_54037 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__48119__auto__ = config;
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_54037;
}});
});
...
return (function() { 
var G__54040__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e54039){var e = e54039;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__54040 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54041__i = 0, G__54041__a = new Array(arguments.length -  0);
while (G__54041__i < G__54041__a.length) {G__54041__a[G__54041__i] = arguments[G__54041__i + 0]; ++G__54041__i;}
  args = new cljs.core.IndexedSeq(G__54041__a,0);
} 
return G__54040__delegate.call(this,args);};
G__54040.cljs$lang$maxFixedArity = 0;
G__54040.cljs$lang$applyTo = (function (arglist__54042){
var args = cljs.core.seq(arglist__54042);
return G__54040__delegate(args);
});
...
var pre_handler = (function (){var or__48119__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
...
var post_handler = (function (){var or__48119__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
return cljs.core.identity;
