...
var len__49232__auto___53554 = arguments.length;
var i__49233__auto___53555 = (0);
while(true){
if((i__49233__auto___53555 < len__49232__auto___53554)){
args__49239__auto__.push((arguments[i__49233__auto___53555]));

var G__53556 = (i__49233__auto___53555 + (1));
i__49233__auto___53555 = G__53556;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49240__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq53552){
var G__53553 = cljs.core.first.call(null,seq53552);
var seq53552__$1 = cljs.core.next.call(null,seq53552);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__53553,seq53552__$1);
});
...
return (function (p1__53557_SHARP_){
return (p1__53557_SHARP_ === object);
});})(history))
,history);
});
