...
var reader = (function (){var or__48119__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__48119__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__48119__auto__)){
return or__48119__auto__;
} else {
return (128);
...
var map__65143 = top_item;
var map__65143__$1 = ((((!((map__65143 == null)))?((((map__65143.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65143.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__65143):map__65143);
var file = cljs.core.get.call(null,map__65143__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__65143__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__65143__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e65142){var _e = e65142;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___65145 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___65145)){
var seen_errors_65146 = temp__4655__auto___65145;
if(cljs.core.truth_(seen_errors_65146.has(self))){
} else {
seen_errors_65146.add(self);

var temp__4657__auto___65147 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___65147)){
var sense_65148 = temp__4657__auto___65147;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_65148)].join('');
} else {
}
}
} else {
