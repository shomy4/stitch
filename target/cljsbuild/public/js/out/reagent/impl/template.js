...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__48730__auto__,writer__48731__auto__,opt__48732__auto__){
return cljs.core._write.call(null,writer__48731__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__55089 = o;
(G__55089[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__55090__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__55090 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55091__i = 0, G__55091__a = new Array(arguments.length -  0);
while (G__55091__i < G__55091__a.length) {G__55091__a[G__55091__i] = arguments[G__55091__i + 0]; ++G__55091__i;}
  args = new cljs.core.IndexedSeq(G__55091__a,0);
} 
return G__55090__delegate.call(this,args);};
G__55090.cljs$lang$maxFixedArity = 0;
G__55090.cljs$lang$applyTo = (function (arglist__55092){
var args = cljs.core.seq(arglist__55092);
return G__55090__delegate(args);
});
G__55090.cljs$core$IFn$_invoke$arity$variadic = G__55090__delegate;
return G__55090;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__48107__auto__ = !((jsprops == null));
if(and__48107__auto__){
var and__48107__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__55097 = jsprops;
(G__55097["defaultValue"] = value);

(G__55097["onChange"] = ((function (G__55097,v,value,on_change){
return (function (p1__55095_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__55095_SHARP_);
});})(G__55097,v,value,on_change))
);
...
var vec__55104 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__55104,(0),null);
var id = cljs.core.nth.call(null,vec__55104,(1),null);
var class$ = cljs.core.nth.call(null,vec__55104,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___55109 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___55109 == null)){
} else {
var key_55110 = temp__4661__auto___55109;
(jsprops["key"] = key_55110);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__55112 = (new reagent.impl.template.NativeWrapper());
(G__55112["name"] = c);
...
var len__49232__auto___55118 = arguments.length;
var i__49233__auto___55119 = (0);
while(true){
if((i__49233__auto___55119 < len__49232__auto___55118)){
args__49239__auto__.push((arguments[i__49233__auto___55119]));

var G__55120 = (i__49233__auto___55119 + (1));
i__49233__auto___55119 = G__55120;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49240__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq55116){
var G__55117 = cljs.core.first.call(null,seq55116);
var seq55116__$1 = cljs.core.next.call(null,seq55116);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__55117,seq55116__$1);
});
...
break;
default:
var G__55124 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__55124;
continue;
...
var n__49042__auto___55127 = a.length;
var i_55128 = (0);
while(true){
if((i_55128 < n__49042__auto___55127)){
(a[i_55128] = reagent.impl.template.as_element.call(null,(a[i_55128])));

var G__55129 = (i_55128 + (1));
i_55128 = G__55129;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__49042__auto___55130 = a.length;
var i_55131 = (0);
while(true){
if((i_55131 < n__49042__auto___55130)){
var val_55132 = (a[i_55131]);
if((cljs.core.vector_QMARK_.call(null,val_55132)) && ((reagent.impl.template.key_from_vec.call(null,val_55132) == null))){
(o["no-key"] = true);
} else {
}

(a[i_55131] = reagent.impl.template.as_element.call(null,val_55132));

var G__55133 = (i_55131 + (1));
i_55131 = G__55133;
continue;
} else {
}
...
var ctx = ({});
var vec__55137 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__55137,(0),null);
var derefed = cljs.core.nth.call(null,vec__55137,(1),null);
...
var G__55141 = (cljs.core.count.call(null,argv) - first_child);
switch (G__55141) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__55141){
